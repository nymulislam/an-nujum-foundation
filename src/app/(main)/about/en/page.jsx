...
const AboutHero = () => {
    ...
    return (
        <section ref={ref} className="relative bg-[#060606] overflow-hidden text-white min-h-[80vh] flex items-center">
            ...
            {/* Giant ن watermark */}
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-[0.018]">
                <span className="font-serif text-[50vw] text-amber-400 leading-none select-none">ن</span>
            </div>
            ...
            <div className="container mx-auto px-4 relative z-10 text-center py-40">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                    <SectionLabel>Who We Are · About Us</SectionLabel>
                </motion.div>
                ...
                <motion.p
                    ...
                    An-Nujum Foundation — meaning "The Stars" — is a tireless endeavor to illuminate the darkness in society.
                    Guided by Islamic ideals and universal human values, we work to transform the lives of the marginalized.
                </motion.p>
        ...
        <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                ...
                <motion.div
                    initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }}
                    viewport={{ once: true }} transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}>
                    <SectionLabel>The Name Behind</SectionLabel>
                    <h2 className="font-serif text-4xl md:text-5xl font-bold text-white leading-[1.15] mb-8">
                        Why <span className="text-amber-400">An-Nujum?</span>
                    </h2>
                    <p className="text-slate-400 text-[17px] leading-[1.95] mb-6">
                        The Arabic word <span className="text-amber-400 font-serif italic">النجوم</span> means "The Stars." Just as stars guide travellers through the darkest nights, An-Nujum Foundation aspires to be a beacon of hope — illuminating the path for those lost in the shadows of poverty and hardship.
                    </p>
                    <p className="text-slate-400 text-[17px] leading-[1.95] mb-8">
                        Founded in 2021, the foundation is non-political, non-profit, and wholly dedicated to public welfare. Our journey rests on two pillars: spreading the beauty of Islam and serving humanity with sincerity and compassion.
                    </p>
                    {/* Key dates */}
                    <div className="flex gap-8">
                        {[
                            { year: "2021", label: "Year Founded" },
                            { year: "5+", label: "Years of Service" },
                            { year: "3+", label: "Districts Active" },
                        ].map((d, i) => (
...
const pillars = [
    {
        ...
        english: "Faith",
        desc: "Every action we take is grounded in Islamic belief and conviction. Seeking the pleasure of Allah is our ultimate purpose — the compass that guides every initiative we undertake.",
    ...
    },
    {
        ...
        english: "Excellence",
        desc: "We serve with the highest standard of excellence — as though Allah is watching. Every act of aid reflects sincerity, dignity, and genuine care for those we serve.",
    ...
    },
    {
        ...
        english: "Trust",
        desc: "We uphold complete transparency and accountability to protect the trust of our donors and the rights of our beneficiaries. Every taka is a sacred responsibility.",
    ...
    <section className="bg-[#050505] text-white py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-20">
                <SectionLabel>Our Founding Principles</SectionLabel>
                <h2 className="font-serif text-5xl md:text-6xl font-bold text-white">
                    Three <span className="text-amber-400">Pillars</span>
                </h2>
                <p className="text-slate-500 mt-4 text-lg max-w-xl mx-auto">The three values that guide every step An-Nujum Foundation takes</p>
            </div>
                ...
                {pillars.map((p, i) => (
                    <motion.div key={i}
                        ...
                        <div className="bg-[#0d0d0d] border border-white/5 rounded-[40px] p-10 hover:border-amber-400/25 hover:bg-[#131313] transition-all duration-700 overflow-hidden h-full">
                            ...
                            <p className="text-white font-bold text-2xl font-serif mb-5">{p.english}</p>
...
const objectives = [
    {
        ...
        title: "Promoting Islamic Education & Values",
        desc: "Spreading the fundamental teachings, ideals, and moral values of Islam throughout society — nurturing a community rooted in faith and righteous character.",
    ...
    },
    {
        ...
        title: "Preventing Moral Decay & Building Character",
        desc: "Playing an active role in combating social decline by fostering Iman, righteous deeds, and ethical conduct across all segments of the community.",
    ...
    },
    {
        ...
        title: "Uplifting Marginalized Communities",
        desc: "Providing assistance to improve the quality of life for society's most vulnerable — the marginalized, neglected, and underprivileged — with dignity and care.",
    ...
    },
    {
        ...
        title: "Expanding Education & Skill Development",
        desc: "Supporting access to both secular and religious knowledge, and running vocational training programs to build practical skills for a self-reliant future.",
    ...
    },
    {
        ...
        title: "Humanitarian Relief & Welfare Programs",
        desc: "Implementing comprehensive welfare initiatives including the distribution of food, medical aid, clothing, shelter, and emergency relief to those in need.",
        arabic: "الْإِغَاثَة",
    ...
    },
    {
        ...
        title: "Social Peace & Awareness Campaigns",
        desc: "Adopting awareness programs from a religious and ethical standpoint to safeguard national interests and uphold peace and order within the community.",
        arabic: "الصُّلْح",
    ...
    },
    {
        ...
        desc: "Conducting Islamic mentorship and da'wah programs to nurture children, adolescents, and youth into principled, honest, and conscientious citizens.",
    ...
    },
    {
        ...
        title: "Women's Empowerment & Family Development",
        desc: "Expanding opportunities in education, healthcare, and livelihood for women within an Islamic framework — building strong, healthy, and resilient family units.",
    ...
    },
    {
        ...
        desc: "Raising awareness about environmental conservation rooted in the Islamic concept of Khilafah — inspiring communities toward responsible and sustainable living.",
        arabic: "حِفْظُ الْبِيئَة",
        arabicMeaning: "Environmental Care",
        tag: "Environment",
    },
];
    ...
    return (
        <section className="bg-[#080808] text-white py-32 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                {/* Section Header */}
                <div className="text-center mb-20">
                    <SectionLabel>Objectives & Goals</SectionLabel>
                    ...
                    <p className="text-slate-500 text-lg max-w-2xl mx-auto leading-relaxed">
                        The objectives and goals An-Nujum Foundation relentlessly works to realise — each one a promise to the communities we serve
                    </p>
                </div>
...
const VerseBanner = () => (
    <section className="bg-amber-400 py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <p className="text-black/35 text-xs mt-4 uppercase tracking-[0.3em]">— Surah Al-Ma&apos;idah, Verse 2</p>
        </div>
    </section>
);
...
═══════════════════════════════════════ */
const team = [
    { name: "Founder & President", nameEn: "مؤسس ورئيس", initial: "م", desc: "A visionary leader with deep expertise in Islamic philosophy and community service, guiding the foundation with wisdom and dedication." },
    { name: "Executive Director", nameEn: "مدير تنفيذي", initial: "ع", desc: "An expert in administration and community development, ensuring every program is executed with precision and compassion." },
    { name: "Program Coordinator", nameEn: "منسق البرامج", initial: "ف", desc: "Skilled and devoted in managing field-level operations, bridging the foundation's mission with real-world impact." },
];
        ...
        <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-16">
                ...
                <h2 className="font-serif text-5xl font-bold text-white">
                    Our <span className="text-amber-400">Governing Board</span>
                </h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                {team.map((t, i) => (
                    <motion.div key={i}
                        ...
                        <p className="text-amber-400/50 text-xs uppercase tracking-[0.2em] mb-4 font-serif" dir="rtl">{t.nameEn}</p>
...
═══════════════════════════════════════ */
const processSteps = [
    { icon: "solar:hand-money-bold", title: "Fundraising", desc: "Collecting Zakat, Sadaqah, and donations — with meticulous record-keeping and full financial accountability." },
    { icon: "solar:eye-bold", title: "Verification & Selection", desc: "Identifying genuine beneficiaries through direct field-level verification, ensuring aid reaches those truly in need." },
    { icon: "solar:transfer-horizontal-bold", title: "Direct Distribution", desc: "Delivering assistance straight to beneficiaries without intermediaries — maximising impact and minimising waste." },
    { icon: "solar:document-text-bold", title: "Reporting & Transparency", desc: "Publishing regular activity reports and financial statements to ensure complete openness to all stakeholders." },
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <h2 className="font-serif text-4xl md:text-5xl font-bold text-white leading-[1.15] mb-6">
                        Built on{" "}
                        <span className="text-amber-400">Complete Transparency</span>
                    </h2>
                    <p className="text-slate-400 text-[17px] leading-[1.9] mb-8">
                        Every taka entrusted to us reaches the right hands. To ensure this, we follow a rigorous four-step process grounded in accountability and trust.
                    </p>
                    {/* Trust badges */}
                    <div className="flex flex-wrap gap-3">
                        {["Zakat Eligible", "Audited Funds", "Registered NGO", "100% Halal"].map((b) => (
        ...
        <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
                ...
                <h2 className="font-serif text-5xl md:text-6xl font-bold text-white mb-6">
                    Join Us in<br />
                    <span className="text-amber-400">Making a Difference</span>
                </h2>
                <p className="text-slate-400 text-lg leading-relaxed mb-12 max-w-xl mx-auto">
                    &quot;Whoever fulfils the needs of his brother, Allah will fulfil his needs.&quot;<br />
                    <span className="text-amber-400/50 text-sm">— Bukhari</span>
                </p>
