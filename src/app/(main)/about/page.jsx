...
const IslamicStar = ({ className = "" }) => (
  <svg viewBox="0 0 400 400" fill="none" className={className} aria-hidden="true">
    ...
    <polygon
      ...
      stroke="currentColor" strokeWidth="1.1" fill="currentColor" fillOpacity="0.06" />
  </svg>
);
...
const SectionLabel = ({ children, light = false }) => (
  <div className={`inline-flex items-center gap-2 border text-[11px] font-bold tracking-[0.22em] uppercase rounded-full px-5 py-2 mb-6 ${
    light
...
const GoldDivider = () => (
  <div className="flex items-center justify-center gap-5 my-20">
    ...
    <svg viewBox="0 0 60 60" className="w-7 h-7 text-amber-400/50 flex-shrink-0" fill="currentColor">
      <polygon points="30,5 33,22 50,15 38,28 55,33 38,33 44,50 30,40 16,50 22,33 5,33 22,28 10,15 27,22" />
    </svg>
    <svg viewBox="0 0 40 40" className="w-4 h-4 text-amber-400/30 flex-shrink-0" fill="currentColor">
      <polygon points="20,3 22,15 34,10 26,20 34,27 22,25 20,37 18,25 6,27 14,20 6,10 18,15" />
    </svg>
    <svg viewBox="0 0 60 60" className="w-7 h-7 text-amber-400/50 flex-shrink-0" fill="currentColor">
      <polygon points="30,5 33,22 50,15 38,28 55,33 38,33 44,50 30,40 16,50 22,33 5,33 22,28 10,15 27,22" />
    </svg>
...
const objectives = [
  ...
  },
  {
    number: "০২",
    arabicNum: "٢",
    icon: "solar:shield-heart-bold",
    title: "নৈতিক অবক্ষয় রোধ ও চরিত্র গঠন",
  ...
  },
  {
    ...
    bangla: "জাতীয় স্বার্থ ও সমাজের শান্তি-শৃঙ্খলা রক্ষায় ধর্মীয় ও নৈতিক দৃষ্টিভঙ্গি থেকে সচেতনতামূলক কর্মসূচি গ্রহণ।",
    arabic: "الصُّلْح",
  ...
  },
  {
    ...
    bangla: "শিশু-কিশোর ও যুব সমাজকে আদর্শ, সৎ ও সচেতন নাগরিক হিসেবে গড়ে তোলার লক্ষ্যে ইসলামী পরিবেশে দীক্ষা ও দাওয়াতি কর্মসূচি পরিচালনা।",
  ...
  },
  {
    ...
    bangla: "ইসলামের খেলাফতের ধারণা থেকে পরিবেশ সংরক্ষণে সচেতনতা তৈরি করা এবং টেকসই জীবনযাপনে অনুপ্রাণিত করা।",
        ...
        <div className="space-y-5">
          {objectives.map((obj, i) => (
            <motion.div
              ...
              className={`group relative rounded-[28px] border transition-all duration-500 cursor-default overflow-hidden ${
                hovered === i
                  ? "bg-[#141414] border-amber-400/30 shadow-[0_0_60px_rgba(251,191,36,0.05)]"
                  : "bg-[#0c0c0c] border-white/5"
              }`}>
              {/* Arabic number watermark */}
              <div className={`absolute right-8 top-1/2 -translate-y-1/2 font-serif font-bold text-[100px] leading-none select-none transition-opacity duration-500 ${
                hovered === i ? "opacity-[0.06]" : "opacity-[0.03]"
              ...
              <div className="relative z-10 flex items-start gap-6 md:gap-10 p-7 md:p-9">
                ...
                <div className={`flex-shrink-0 w-14 h-14 rounded-xl flex items-center justify-center transition-all duration-500 ${
                  hovered === i ? "bg-amber-400" : "bg-amber-400/8 border border-amber-400/15"
                }`}>
                  <Icon icon={obj.icon} className={`text-2xl transition-colors duration-500 ${
                    hovered === i ? "text-black" : "text-amber-400/60"
                  }`} />
                </div>
...
═══════════════════════════════════════ */
const processSteps = [
  { icon: "solar:hand-money-bold", title: "অনুদান সংগ্রহ", desc: "জাকাত, সাদাকাহ ও দান সংগ্রহ — সম্পূর্ণ হিসাব রক্ষণাবেক্ষণ সহ।" },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            {["জাকাত যোগ্য", "অডিটেড ফান্ড", "সরকার নিবন্ধিত", "১০০% হালাল"].map((b) => (
